...
!(function (e, t) {
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            (this.readyState = "closed"),
                                p(s(i.prototype), "emitReserved", this).call(this, "close", e);
                        },
                    },
                        ...
                        value: function () {
                            var e =
                                arguments.length > 0 && void 0 !== arguments[0]
                                    ...
                                    : {};
                            return (
                                i(e, { xd: this.xd, cookieJar: this.cookieJar }, this.opts),
                                new se(this.uri(), e)
                            );
                        },
                    },
    ...
    if (
        ((se.requestsCount = 0), (se.requests = {}), "undefined" != typeof document)
    )
    ...
    var ce =
        ...
        fe = (function (e) {
            ...
            function i(e) {
                var r;
                return (
                    t(this, i), ((r = n.call(this, e)).supportsBinary = !e.forceBase64), r
                );
            }
            return (
                r(i, [
                                ...
                                ((this.transport = new WebTransport(
                                    ...
                                    this.transport.ready.then(function () {
                                        e.transport.createBidirectionalStream().then(function (t) {
                                            ...
                                            var o = { type: "open" };
                                            e.query.sid &&
                                                (o.data = '{"sid":"'.concat(e.query.sid, '"}')),
                                                e.writer.write(o).then(function () {
                                                    return e.onOpen();
                                                });
                                        });
                                    }));
                                    ...
                                    n.once("packet", function (e) {
                                        if (!r)
                                            if ("pong" === e.type && "probe" === e.data) {
                                                if (
                                                    ((t.upgrading = !0), t.emitReserved("upgrading", n), !n)
                                                )
                                                    return;
    ...
    function Oe(e) {
        var t = [],
            ...
            r = e;
        return (
            (r.data = Te(n, t)), (r.attachments = t.length), { packet: r, buffers: t }
        );
    }
    function Te(t, n) {
        if (!t) return t;
        ...
        if ("object" === e(t) && !(t instanceof Date)) {
            var s = {};
            for (var a in t)
                Object.prototype.hasOwnProperty.call(t, a) && (s[a] = Te(t[a], n));
            return s;
        }
        return t;
    }
    ...
    function Ce(t, n) {
        ...
        if (Array.isArray(t)) for (var r = 0; r < t.length; r++) t[r] = Ce(t[r], n);
        else if ("object" === e(t))
            for (var i in t)
                Object.prototype.hasOwnProperty.call(t, i) && (t[i] = Ce(t[i], n));
        return t;
    }
    var Be,
        Se = [
            ...
            r(e, [
                {
                    key: "encode",
                    value: function (e) {
                        return (e.type !== Be.EVENT && e.type !== Be.ACK) || !Ae(e)
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            if (n.type === Be.BINARY_EVENT || n.type === Be.BINARY_ACK) {
                                for (var r = t + 1; "-" !== e.charAt(++t) && t != e.length;);
                            ...
                            switch (e) {
                                ...
                                case Be.BINARY_EVENT:
                                    return (
                                        Array.isArray(t) &&
                                        ("number" == typeof t[0] ||
                                            ("string" == typeof t[0] && -1 === Se.indexOf(t[0])))
                                    );
                                case Be.ACK:
                                case Be.BINARY_ACK:
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            this.packet({
                                type: Be.CONNECT,
                                data: this._pid
                                    ? i({ pid: this._pid, offset: this._lastOffset }, e)
                                    : e,
                            });
                        },
                    },
                        ...
                        value: function () {
                            ...
                            Object.keys(this.acks).forEach(function (t) {
                                if (
                                    ...
                                    delete e.acks[t],
                                        n.withError &&
                                        n.call(e, new Error("socket has been disconnected"));
                                }
                            });
                        },
                    },
                    ...
                    value: function (e, t) {
                        ...
                        return (
                            n
                                ...
                                : ((n = new Ue(this, e, t)), (this.nsps[e] = n)),
                            n
                        );
                    },
                },
